...
export default function NewsView({ news }: { news: NewsRow[] }) {
  return (
    <div className="p-8">
      <div className="mb-6">
          ...
          {news.map((item, i) => (
            ...
            >
              <div className="relative h-44 overflow-hidden">
                ...
                <span className={`absolute left-4 top-4 rounded-full border px-2.5 py-0.5 font-mono text-[10px] uppercase tracking-wide ${categoryColor[item.category] ?? categoryColor['Новость']}`}>
                  {item.category}
                </span>
              </div>
              <div className="p-5">
