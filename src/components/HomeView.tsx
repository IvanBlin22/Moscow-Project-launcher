...
import { SERVERS, NEWS, HERO_IMAGE, formatBytes } from '../data'
        ...
        <div className="relative flex h-full flex-col justify-end p-8">
          <div className="animate-fade-up">
            ...
            <p className="mt-2 max-w-xl text-base text-ink-200">
              Новый район Останкино, 14 машин, переработанная экономика и система гаражей. Заходи и играй.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-5 p-8">
        ...
        <div className="col-span-2 space-y-5">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[
              { icon: Users, label: 'Игроков онлайн', value: '1 259', color: 'text-accent-400' },
              { icon: Signal, label: 'Серверов', value: '3', color: 'text-gold-300' },
              { icon: TrendingUp, label: 'Рекорд онлайна', value: '2 104', color: 'text-ink-100' },
              { icon: Clock, label: 'Аптайм', value: '99.8%', color: 'text-ink-100' },
            ].map((s, i) => {
              const Icon = s.icon
              return (
                <div
          ...
          <div>
            ...
            <div className="space-y-2">
              {SERVERS.map((s, i) => {
                ...
                const fillPct = (s.players / s.maxPlayers) * 100
                return (
                  <button
                    key={i}
          ...
          <div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-white/5">
              ...
              <div className="absolute inset-0 flex flex-col justify-center p-6">
                ...
                <span className="mt-2 font-mono text-[11px] text-ink-400">{featured.date}</span>
              </div>
            </div>
          </div>
        </div>
